...
<body>
	<div id="wrapper">
			...
			<div id="page-bgtop">
				<div id="content">
					...
					<div class="post">
						...
						<div class="entry">
							<p>
								Et feriez vous confiance &agrave; une banque non securis&eacute;e?
							</p>
						</div>
					</div>
				</div>
					...
					<ul>
						<li>
							...
							<p>Mauris vitae nisl nec metus placerat perdiet est.
								...
								consectetuer hendrerit, volutpat.</p></li>
						<li>
							<h2>Pellenteque ornare</h2>
							<ul>
								<li><a href="#"></a><a href="#">Nec metus sed donec</a>
								</li>
		...
		<div id="footer">
			<p>
				Copyright (c) 2011 Yaeba.com. All rights reserved. Code by <a
					href="http://www.excilys.com/">excilys</a>.
			</p>
			<br />
			<p>
				Copyright (c) 2008 Yaeba.com. All rights reserved. Design by <a
