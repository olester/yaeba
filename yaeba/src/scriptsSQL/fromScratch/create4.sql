...
CREATE TABLE IF NOT EXISTS `compte` (
  ...
  `soldecourant` decimal(19,2) NOT NULL,
...
CREATE TABLE IF NOT EXISTS `operationvirementinterne` (
  `id` int(11) NOT NULL,
  `comptedistant` int(11) DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `operationvirementinterne_operation` (`id`),
  KEY `operationvirementinterne_comptedistant` (`comptedistant`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
...
ALTER TABLE `operationvirementinterne`
  ...
  ADD CONSTRAINT `operationvirementinterne_comptedistant` FOREIGN KEY (`comptedistant`) REFERENCES `compte` (`id`);
